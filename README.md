...
## Increase Max Results per Page from WP Rest Api

```php

function increase_results_per_page( $params ) {
...
function jz_file_and_ext_webp( $types, $file, $filename, $mimes ) {
...
function jz_mime_types_webp( $mimes ) {
